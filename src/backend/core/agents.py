...
class AgentManager:
    ...
    def __initialize_agents__(self):
        ...
        requirements_analyst = Agent(
            ...
            tools=[self._file_write_tool, self._directory_read_tool, self._file_read_tool] + self._search_tools,
            verbose=True,
        ...
        backend_ai_developer = Agent(
            ...
            tools=[self._file_write_tool, self._directory_read_tool, self._file_read_tool] + self._search_tools,  # Search for AI best practices
            verbose=True,
            respect_context_window=True,  # Enables automatic handling of context window limits
        ...
        tester = Agent(
            ...
            tools=[self._file_write_tool, self._directory_read_tool, self._file_read_tool] + self._search_tools,  # To read generated code for testing
            verbose=True,
            respect_context_window=True,  # Enables automatic handling of context window limits
            allow_delegation=False,
            max_retry_limit=15,
